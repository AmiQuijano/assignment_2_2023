...
import rospy
import math
from assignment_2_2023.srv import GetDistSpeed, GetDistSpeedResponse  # Import the custom service message
from assignment_2_2023.msg import PosVel # Import the custom message type
